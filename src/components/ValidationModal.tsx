...
export default function ValidationModal({ onClose }: ValidationModalProps) {
        ...
        <Card className="relative p-8 rounded-lg shadow-xl bg-white w-full max-w-md text-center">
          ...
          {userInfo.role === "user" ? (
              <p className="text-gray-600 mb-4">
                Your account is for job seekers. To upload job opportunities, please
                create an employer account.
              </p>
          ) : (
              <p className="text-gray-600 mb-4">
                Your account is for employers. To browse and apply for jobs, please
