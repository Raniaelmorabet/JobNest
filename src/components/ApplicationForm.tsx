...
// Define the shape of the job details object
interface JobDetails {
  id: string;
  [key: string]: any; // Allow additional properties
}

// Define the props for the ApplicationForm component
...
export function ApplicationForm({ jobTitle, onClose, jobDetails }: ApplicationFormProps): JSX.Element {
